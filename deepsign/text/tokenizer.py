...
pureWord = r"^\p{L}+$"
pureNumber = r"^\p{N}*([\.,]?\p{N}+)$"
clitic = r"\w+'\w{0,2}|'\w{1,2}"
...
punctuationChars = r"['\"“”‘’.?!…,:;]"
punctuationSequence = r"['\"“”‘’]+|[.?!,…]+|[:;]+"  # 'anthem'. => ' anthem ' .
...
urlBody = r"(?:[^\.\s<>][^\s<>]*?)?"
urlExtraCrapBeforeEnd = regex_or(punctuationChars, entity) + "+?"
urlEnd = r"(?:\.\.+|[<>]|\s|$)"
...
basicFaceLeft = u"(♥|0|[oO]|°|[vV]|\\$|[tT]|[xX]|;|\u0ca0|@|ʘ|•|・|◕|\\^|¬|\\*)"
basicFaceCenter = r"(?:[\.]|[_-]+)"
basicFaceRight = r"\2"
s3 = r"(?:--['\"])"
s4 = r"(?:<|&lt;|>|&gt;)[\._-]+(?:<|&lt;|>|&gt;)"
...
basicFace = "(?:" + basicFaceLeft + basicFaceCenter + basicFaceRight + ")|" + s3 + "|" + s4 + "|" + s5
...
oOEmote = r"(?:[oO]" + basicFaceCenter + r"[oO])"
