...
parser.add_argument('-k_dim', dest="k_dim", type=int, default=4000)
parser.add_argument('-s_active', dest="s_active", type=int, default=10)
...
ri_generator = ri.Generator(dim=args.k_dim, num_active=args.s_active)
...
def nrp_encode(ctx_ids, target_ids):
    ...
    class_target = np.array([rindex.to_class_indices() for rindex in target_ris])
