...
from deepsign.models.models import NRP
...
parser.add_argument('-ri_dim', dest="ri_dim", type=int, default=10000)
parser.add_argument('-ri_s', dest="ri_s", type=float, default=0.1)
...
model = NRP(run_inputs=inputs, loss_inputs=loss_inputs,
