...
from tensorx.sparsemax_2.sparsemax import sparsemax
from tensorx.sparsemax_2.sparsemax_loss import sparsemax_loss
...
def grad_sparsemax(op, grad):
    ...
    v_hat = tf.reduce_sum(grad * support, 1) / tf.reduce_sum(support, 1)
