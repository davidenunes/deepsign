...
from tensorx.sparsemax_2 import sparsemax_tf_ops
...
class TestSparseMax(TestCase):

    def test_sparsemax_of_zero(self):
    ...
    def test_sparsemax_of_inf(self):
