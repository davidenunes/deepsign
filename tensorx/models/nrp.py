...
from tensorx.layers import Input, Dense, Act, Embeddings, FeatureInput
...
class NRPDAE:
    ...
    def __init__(self,
        ...
        self.pos_input = FeatureInput(n_units=k_dim,n_active=num_pos,dtype=tf.int32,name="positive features")
        self.neg_input = FeatureInput(n_units=k_dim,n_active=num_neg,dtype=tf.int32,name="negative features")
